...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		vegetarianCheckbox = findViewById(R.id.checkBox1);
		...
		final ListView mealsListView = findViewById(R.id.listView1);
	...
	private void onRefreshBtnClick() {
		...
		openMensaAPI.getMeals("2023-05-02").enqueue(new Callback<List<Meal>>() {
			@Override
